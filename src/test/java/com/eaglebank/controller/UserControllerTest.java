...
class UserControllerTest {
    ...
    private final String token = "eyJhbGc.valid.token";
    ...
    void create_success() {
        ...
        verify(authenticationService).create(userResponse.id(), request.password(), Role.CUSTOMER);
    }

    @Test
    void get_success() {
        String userId = "usr-namone1";
        UserResponse userResponse = new UserResponse("1", "Name One",
                new AddressResource("L1", "", "", "T1", "C1", "P1"),
                "0123456789", "email@example.com");
        ...
        ResponseEntity<UserResponse> response = userController.getUserById(bearerToken, userId);
    ...
    void update_success() {
        ...
        ResponseEntity<UserResponse> response = userController.updateUserById(bearerToken, userId, updateRequest);
    ...
    void delete_success() {
        ...
        ResponseEntity<Void> response = userController.deleteUser(bearerToken, userId);
